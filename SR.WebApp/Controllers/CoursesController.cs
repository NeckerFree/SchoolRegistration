...
namespace SR.WebApp.Controllers
{
    public class CoursesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,CreationDate,Active")] Course course)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Id,Name,CreationDate,Active")] Course course)
        {
            if (id != course.Id)
            {
                return NotFound();
